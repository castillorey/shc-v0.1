...
class Dispositivos_model extends CI_Model {
    ...
    public function eliminar($nameDisp,$tipo){

			$dato = array($tipo => "");
	    	$this->db->where($tipo, $nameDisp);
			$this->db->update('cajasdetomas', $dato);
    }
    public function editar($nombre, $nombreNuevo){
    	$dato = array('nombre' => $nombreNuevo);
    	$this->db->where('nombre', $nombre);
		$this->db->update('cajadetomas', $dato);
    }
